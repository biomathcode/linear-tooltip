...
class LinearTooltip extends r$1 {
    ...
    static lazy(target, callback) {
        const createTooltip = () => {
            const tooltip = document.createElement('linear-tooltip');
            callback(tooltip);
...
__decorate([
    n({ type: Number })
], LinearTooltip.prototype, "offset", void 0);
__decorate([
    n({ reflect: true, type: Boolean })
], LinearTooltip.prototype, "showing", void 0);

window.customElements.define('linear-tooltip', LinearTooltip);

var index_stories = {
    title: 'LinearTooltip',
    component: 'linear-tooltip',
    argTypes: {
        header: { control: 'text' },
